...
import org.apache.activemq.util.HyperAwareObjectInputStream;
 ...
 */
public class ActiveMQObjectMessage3 extends ActiveMQMessage implements ObjectMessage {

    // TODO: verify classloader
    public static final byte DATA_STRUCTURE_TYPE = CommandTypes.ACTIVEMQ_OBJECT_MESSAGE;
    static final ClassLoader ACTIVEMQ_CLASSLOADER = ActiveMQObjectMessage3.class.getClassLoader();

    protected transient Serializable object;

    public Message copy() {
        ActiveMQObjectMessage3 copy = new ActiveMQObjectMessage3();
        copy(copy);
        return copy;
    }

    private void copy(ActiveMQObjectMessage3 copy) {
    ...
    public Serializable getObject() throws JMSException {
        if (object == null && getContent() != null) {
            try {
                ...
                HyperAwareObjectInputStream objIn = new HyperAwareObjectInputStream(dataIn);
                objIn.setTrustedPackages(Arrays.asList(HyperAwareObjectInputStream.serializablePackages));
                try {
