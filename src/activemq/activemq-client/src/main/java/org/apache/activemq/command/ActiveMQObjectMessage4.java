 ...
 */
public class ActiveMQObjectMessage4 extends ActiveMQMessage implements ObjectMessage {

    // TODO: verify classloader
    public static final byte DATA_STRUCTURE_TYPE = CommandTypes.ACTIVEMQ_OBJECT_MESSAGE;
    static final ClassLoader ACTIVEMQ_CLASSLOADER = ActiveMQObjectMessage4.class.getClassLoader();

    protected transient Serializable object;

    public Message copy() {
        ActiveMQObjectMessage4 copy = new ActiveMQObjectMessage4();
        copy(copy);
        return copy;
    }

    private void copy(ActiveMQObjectMessage4 copy) {
    ...
    public Serializable getObject() throws JMSException {
        if (object == null && getContent() != null) {
            try {
                ...
                objIn.setTrustAllPackages(true);
                try {
