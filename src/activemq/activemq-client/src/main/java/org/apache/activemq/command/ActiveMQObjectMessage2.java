 ...
 */
public class ActiveMQObjectMessage2 extends ActiveMQMessage implements ObjectMessage {
    ...
    public Message copy() {
        ActiveMQObjectMessage2 copy = new ActiveMQObjectMessage2();
        copy(copy);
        return copy;
    }

    private void copy(ActiveMQObjectMessage2 copy) {
