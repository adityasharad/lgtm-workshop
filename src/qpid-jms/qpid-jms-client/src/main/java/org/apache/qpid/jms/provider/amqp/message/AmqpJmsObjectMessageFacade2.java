 ...
 * type.
 */
public class AmqpJmsObjectMessageFacade2 extends AmqpJmsMessageFacade implements JmsObjectMessageFacade {
     ...
     */
    public AmqpJmsObjectMessageFacade2(AmqpConnection connection, boolean isAmqpTypeEncoded) {
        super(connection);
     ...
     */
    public AmqpJmsObjectMessageFacade2(AmqpConsumer consumer, Message message, ByteBuf messageBytes) {
    ...
    @Override
    public AmqpJmsObjectMessageFacade2 copy() throws JMSException {
        AmqpJmsObjectMessageFacade2 copy = new AmqpJmsObjectMessageFacade2(connection, isAmqpTypedEncoding());
        copyInto(copy);
        ...
        if (useAmqpTypedEncoding != delegate.isAmqpTypeEncoded()) {
            try {
                ...
                if (useAmqpTypedEncoding) {
                    ...
                    newDelegate = new AmqpSerializedObjectDelegate2(message, null);
                }
    ...
    private void initDelegate(boolean useAmqpTypes, ByteBuf messageBytes) {
        if (!useAmqpTypes) {
            delegate = new AmqpSerializedObjectDelegate2(getAmqpMessage(), messageBytes);
        } else {
