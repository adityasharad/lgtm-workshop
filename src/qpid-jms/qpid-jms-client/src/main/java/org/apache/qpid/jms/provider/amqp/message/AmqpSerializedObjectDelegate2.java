...
import org.apache.qpid.jms.util.QpidClassLoadingAwareObjectInputStream;
 ...
 * type.
 */
public class AmqpSerializedObjectDelegate2 implements AmqpObjectTypeDelegate {
     ...
     */
    public AmqpSerializedObjectDelegate2(Message message, ByteBuf messageBytes) {
    ...
    public Serializable getObject() throws IOException, ClassNotFoundException {
        ...
        if (bin == null) {
            ...
            try (ByteArrayInputStream bais = new ByteArrayInputStream(bin.getArray(), bin.getArrayOffset(), bin.getLength());
                 QpidClassLoadingAwareObjectInputStream objIn = new QpidClassLoadingAwareObjectInputStream(bais)) {
