...
public class AmqpJmsMessageTypesTestCase extends QpidJmsTestCase {
    ...
    protected AmqpJmsObjectMessageFacade2 createNewObjectMessageFacade(boolean amqpTyped) {
        return new AmqpJmsObjectMessageFacade2(createMockAmqpConnection(), amqpTyped);
    }

    protected AmqpJmsObjectMessageFacade2 createReceivedObjectMessageFacade(AmqpConsumer amqpConsumer, Message message) {
        return new AmqpJmsObjectMessageFacade2(amqpConsumer, message, encodeMessage(message));
    }
