...
public class AmqpJmsObjectMessageFacadeTest extends AmqpJmsMessageTypesTestCase {
    ...
    public void testNewMessageToSendContainsMessageTypeAnnotation() throws Exception {
        AmqpJmsObjectMessageFacade2 amqpObjectMessageFacade = createNewObjectMessageFacade(false);
    ...
    private void doNewMessageToSendReturnsNullObjectTestImpl(boolean amqpTyped) throws Exception {
        AmqpJmsObjectMessageFacade2 amqpObjectMessageFacade = createNewObjectMessageFacade(amqpTyped);
    ...
    private void doNewMessageToSendHasBodySectionRepresentingNull(boolean amqpTyped) throws Exception {
        ...
        if(amqpTyped) {
            ...
            assertSame("Expected existing body section to be replaced", AmqpSerializedObjectDelegate2.NULL_OBJECT_BODY, protonMessage.getBody());
        }
    }
    ...
    public void testSetObjectOnNewAmqpTypedMessage() throws Exception {
        ...
        AmqpJmsObjectMessageFacade2 amqpObjectMessageFacade = createNewObjectMessageFacade(true);
        amqpObjectMessageFacade.setObject(content);
    ...
    public void testSetObjectWithNullClearsExistingBodySection() throws Exception {
        ...
        AmqpJmsObjectMessageFacade2 amqpObjectMessageFacade = createReceivedObjectMessageFacade(createMockAmqpConsumer(), protonMessage);
    ...
    private void doGetObjectUsingReceivedMessageWithNoBodySectionReturnsNullTestImpl(boolean amqpTyped) throws IOException, ClassNotFoundException {
        ...
        AmqpJmsObjectMessageFacade2 amqpObjectMessageFacade = createReceivedObjectMessageFacade(createMockAmqpConsumer(), message);
