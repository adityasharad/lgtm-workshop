...
public class AmqpJmsMessagePropertyIntercepterTest {
    ...
    public void testSetJmsAmqpTypedEncoding() throws JMSException {
        AmqpJmsObjectMessageFacade2 message = createAmqpObjectMessageFacade();
    ...
    private AmqpJmsObjectMessageFacade2 createAmqpObjectMessageFacade() {
        AmqpJmsObjectMessageFacade2 message = Mockito.mock(AmqpJmsObjectMessageFacade2.class);
        Mockito.when(message.getApplicationPropertyNames(Mockito.anySetOf(String.class))).then(new PassPropertyNames());
        return message;
    }
